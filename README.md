...
изменяемое состояние, которое зачастую не нужно. Во второй части статьи авторы предлагают функционально-реляционный подход, где большая часть вычеслений выражена чистыми функциями, а все состояни и работа с ним реализованы через 
